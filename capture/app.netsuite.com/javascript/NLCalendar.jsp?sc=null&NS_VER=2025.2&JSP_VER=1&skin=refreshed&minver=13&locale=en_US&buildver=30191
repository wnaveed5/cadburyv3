...
function getCalendarHTMLHeader( bIsInline, date )
{
    ...
    {
        bIsInline = false;
        return "<table width=100% id='table_null' border=0 cellspacing=0 cellpadding=0 style='margin-bottom: 10px;'><tr class='portletBgColor' id='null'><td width='3' height='20'><img class='portletTitleL' height='100%' width='3' border='0' src='/images/nav/ns_x.gif'></td><td class='portletHeaderBg portletTitleText'><div class='uir-popup-cal-nav' style='text-align:center; white-space: nowrap;'>  <a class='iArrowLeft' style='margin-left: 5px;' href='javascript:void(0);' onclick='prevmonth(false," + bIsInline + "); return false;'></a>  <span class='uir-popup-cal-nav-title textbold' style='display:inline-block; width: 110px; vertical-align:top;'>"+getdatestring(date, 'Mon YYYY')+"</span>  <a class='iArrowRight' style='margin-right: 5px;' href='javascript:void(0);' onclick='nextmonth(false," + bIsInline + "); return false;'></a></div></td><td class='portletHeaderBg portletIcons' id='null_portletIcons' nowrap='true' align='right'></td><td width='3' height='20'><img class='portletTitleR' height='100%' width='3' border='0' src='/images/nav/ns_x.gif'></td></tr><tr class='portletBgColor' id='null_content'><td><img height='1' width='3' vspace='20' src='/images/nav/ns_x.gif'></td><td style='background-color:#FFFFFF;' valign='top' colspan='2'><table width='100%' border='0' cellspacing='0' cellpadding='0' ><tr>";
    }
}
