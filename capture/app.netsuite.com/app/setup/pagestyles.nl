...
.listheadertd		{ border-width: 1px 0 1px 1px; }
.listheadertdleft	{ border-width: 1px 0 1px 0; }
.listheadertdmid	{ border-width: 1px 0 1px 0; }
...
.subtabbarinnerul	{ font-size: 0px; width: 2px; height: 2px; background: url(/images/core/common/corner_r3_t_gray_w.png) #DEE1E7 1px 0px; }
.subtabbarinnerur	{ font-size: 0px; width: 2px; height: 2px; background: url(/images/core/common/corner_r3_t_gray_w.png) #DEE1E7 1px 0px; }
.subtabbarinnerll	{ font-size: 0px; width: 2px; height: 2px; background: url(/images/core/common/corner_r3_t_gray_w.png) #DEE1E7 1px 2px; }
.subtabbarinnerlr	{ font-size: 0px; width: 2px; height: 2px; background: url(/images/core/common/corner_r3_t_gray_w.png) #DEE1E7 1px 2px; }
...
body[data-webstore=true] > #outerwrapper {
	display: flex;
	flex-direction: column;
	height: 100%;
}
body[data-webstore=true] > #outerwrapper > #innerwrapper {
	display: flex;
	flex-direction: column;
	flex-grow: 1;
	min-height: 0;
}
body[data-webstore=true] .uir-list-body-wrapper {
	flex-grow: 1;
	border-bottom: 1px solid #B4B4B4;
}
body[data-webstore=true] .uir-list-headerrow {
	position: sticky;
	top: 0;
	z-index: 1;
}
...
.ac_container,
.ac_container_bot { background-color: #607799; position: relative; z-index: 1000; display: inline-block; }
...
.ac_table { border: 1px solid #B0B0B0; background: #607799 url(/images/chiles/navmenu/pgmenu_main_bg.png) repeat scroll; white-space: nowrap; min-width: 100px; }
...
.pt_title { font-size: 17px;	font-weight: bold;	color: #24385B;	position: relative;	top: 2px; left: 10px; float: left; }
.pt_bg { background-color: #24385B; }
.pt_statusblock {	text-align: center; position: absolute; right: 0px; background-color: #E0E6EF; height: 26px; min-width: 180px; padding-right: 15px; }
...
.pgBntG .bntBgT:not(.uir-page-search__highlight--default) { padding: 1px 6px 0; background: url(/images/chiles/btn_page_bg_t.png) repeat-x scroll left top transparent; }
.pgBntG .bntBgB:not(.uir-page-search__highlight--default) { background: url(/images/chiles/btn_page_bg_b.png) repeat-x scroll left bottom transparent; }
...
.pgBntG_sel .bntBgT:not(.uir-page-search__highlight--default) { padding: 1px 6px 0; background: url(/images/chiles/btn_page_down_bg_t.png) repeat-x scroll left top transparent; }
.pgBntG_sel .bntBgB:not(.uir-page-search__highlight--default) { background: url(/images/chiles/btn_page_down_bg_b.png) repeat-x scroll left bottom transparent; }
...
.pgBntY .bntBgT:not(.uir-page-search__highlight--default) { padding: 1px 6px 0; background: url(/images/chiles/btn_page_hilited_bg_t.png) repeat-x scroll left top transparent; }
.pgBntY .bntBgB:not(.uir-page-search__highlight--default) { background: url(/images/chiles/btn_page_hilited_bg_b.png) repeat-x scroll left bottom transparent; }
...
.pgBntY_sel .bntBgT:not(.uir-page-search__highlight--default) { padding: 1px 6px 0; background: url(/images/chiles/btn_page_hilited_down_bg_t.png) repeat-x scroll left top transparent; }
.pgBntY_sel .bntBgB:not(.uir-page-search__highlight--default) { background: url(/images/chiles/btn_page_hilited_down_bg_b.png) repeat-x scroll left bottom transparent; }
...
.pgBntGDis_sel .bntBgT:not(.uir-page-search__highlight--default),
.pgBntGDis .bntBgT:not(.uir-page-search__highlight--default),
.pgBntYDis_sel .bntBgT:not(.uir-page-search__highlight--default),
.pgBntYDis .bntBgT:not(.uir-page-search__highlight--default) { color: #999999; padding: 1px 0 0; background: url(/images/chiles/btn_form_disabled_bg_t.png) repeat-x scroll left top transparent; }

.pgBntGDis .bntBgB:not(.uir-page-search__highlight--default),
.pgBntYDis .bntBgB:not(.uir-page-search__highlight--default) { background: url(/images/chiles/btn_form_disabled_bg_b.png) repeat-x scroll left bottom transparent; }
...
.tabBnt .bntBgT:not(.uir-page-search__highlight--default),
.tabBnt_sel .bntBgT:not(.uir-page-search__highlight--default) { padding: 1px 0 0; background: url(/images/chiles/btn_form_bg_t.png) repeat-x scroll left top transparent; }

.tabBnt .bntBgB,
.tabBnt_sel .bntBgB:not(.uir-page-search__highlight--default) { background: url(/images/chiles/btn_form_bg_b.png) repeat-x scroll left bottom transparent; }
...
.tabBntDis .bntBgT:not(.uir-page-search__highlight--default) { color: #999999; padding: 1px 0 0; background: url(/images/chiles/btn_form_disabled_bg_t.png) repeat-x scroll left top transparent; }
.tabBntDis .bntBgB:not(.uir-page-search__highlight--default) { background: url(/images/chiles/btn_form_disabled_bg_b.png) repeat-x scroll left bottom transparent; }
...
.portletBgColor { background-color: #607998; }
...
.portletTitleBg { background: #607998 url(/images/icons/dashboard/chiles/dashboard.png) no-repeat right top; height: 20px; }
...
.portletLeftSide { background: #607998 url(/images/icons/dashboard/chiles/dashboard.png) no-repeat left -20px; padding-left: 3px; } 
.portletRightSide { background: #607998 url(/images/icons/dashboard/chiles/dashboard.png) no-repeat right -20px; padding-right: 3px; } 
.portletFooter { background: #607998 url(/images/icons/dashboard/chiles/dashboard.png) no-repeat right -1597px; height: 3px; } 
.portletBottomCorner { background: #607998 url(/images/icons/dashboard/chiles/dashboard.png) no-repeat left -1597px; float: left; padding: 3px 0px 0 10px; zoom: 1; }
.portletIcons { }
...
.plchiles .bgofftab { border-top: 1px solid #AFB5BF; border-bottom: 1px solid #333333; background: url(/images/tabs/png/chiles/menu_sprite.png) repeat scroll -50px 0px; padding: 0 7px; background-color: #607799; }
...
.bgtabrborder_s { border-bottom: 1px solid #333333; border-top: 1px solid #AFB5BF; background-color: #24385B; }
...
.menuTableDiv { border: 1px solid #B5B5B5; background-color: #EBEFF5; padding: 0 1px; }
...
.portlet		{ background-color: #607998; }
.portletlabel		{ color: #FFFFFF; background-color: #607998; }
.portletlabelDragDrop	{ color: #FFFFFF; background-color: #607998; }
.portletDragDropIcon	{ cursor: move; }
.quickaddDragDropIcon	{ cursor: move; }
.portletDragDropBar	{ color: #607799; }
...
.bgmd			{ background-color: #E0E6EF; }
.bgdk			{ background-color: #808080; }
.bgontab		{ background-color: #24385B; text-align: center; vertical-align: middle; }
.bgofftab		{ background-color: #607799; text-align: center; vertical-align: middle; }
.bghovertab		{ background-color: #24385B; text-align: center; vertical-align: middle; }

/* list header */
.listheadertd,
.listheadertdleft	{
	vertical-align: top; height: 100%; border-style: solid; border-color: #B4B4B4;
	background: #607799 url(/images/core/list/header_bg_b.png) repeat-x left bottom;
	box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box;
}

/* form tab bar */
.bgtabbar		{ background-color: #6688C2; }
.bdtabblock		{ border-style: solid; border-color: #6688C2; background-color: #F7F7F7; }
.tabblockcorner		{ background-color: #6688C2; }
.tabcontent		{ background-color: #F7F7F7; padding: 5px 0; }
.nltabcontent		{ background-color: #F7F7F7; padding: 5px 0; }

.formtabon		{ padding: 3px 8px 3px 8px; background: #24385B url(/images/forms/tab/tab_on.png) repeat-x; }
.formtaboff		{ padding: 3px 8px 3px 8px; background: #607799 url(/images/forms/tab/tab_off.png) repeat-x; }
...
.formtabseplon		{ position: relative; width: 2px; vertical-align: top; background: #24385B url(/images/forms/tab/tab_on_l.png) repeat-y; }
.formtabseploff		{ position: relative; width: 2px; vertical-align: top; background: #607799 url(/images/forms/tab/tab_off_l.png) repeat-y; }
.formtabsepron		{ position: relative; width: 5px; vertical-align: top; background: #24385B url(/images/forms/tab/tab_on_r.png) repeat-y; }
.formtabseproff		{ position: relative; width: 5px; vertical-align: top; background: #607799 url(/images/forms/tab/tab_off_r.png) repeat-y; }

/* form tab bar corners */
.formtabsepclon		{ position: relative; top: 0px; width: 5px; height: 5px; font-size: 0px; background: #24385B url(/images/forms/tab/tab_on_corner_l.png) no-repeat; }
.formtabsepcloff	{ position: relative; top: 0px; width: 5px; height: 5px; font-size: 0px; background: #607799 url(/images/forms/tab/tab_off_corner_l.png) no-repeat; }
.formtabsepcron		{ position: relative; top: 0px; width: 5px; height: 5px; font-size: 0px; background: #24385B url(/images/forms/tab/tab_on_corner_r.png) no-repeat; }
.formtabsepcroff	{ position: relative; top: 0px; width: 5px; height: 5px; font-size: 0px; background: #607799 url(/images/forms/tab/tab_off_corner_r.png) no-repeat; }

/* form tab bar corners */
.unrollformtabbar	{ font-size: 8pt; background: #24385B url(/images/forms/tab/unrolltab_bg.png) repeat-x; }
...
.unrollformtabheaderesep	{ height: 3px; font-size: 0px; background: #24385B url(/images/forms/border/unrollsubtab_header_sep.png) repeat-x; }
.unrollformtablexpand		{ width: 4px; font-size: 0px; background: #24385B url(/images/forms/border/unrolltab_l_expand.png) repeat-y; }
.unrollformtabrexpand		{ width: 4px; font-size: 0px; background: #24385B url(/images/forms/border/unrolltab_r_expand.png) repeat-y; }
.unrollformtabtexpand		{ height: 5px; font-size: 0px; background: #24385B url(/images/forms/border/unrolltab_t_expand.png) repeat-x; }
.unrollformtabbexpand		{ height: 5px; font-size: 0px; background: #24385B url(/images/forms/border/unrolltab_b_expand.png) repeat-x; }
.unrollformtabheaderexpand:not(.uir-page-search__highlight--primary)	{ padding: 5px; background: #24385B url(/images/forms/border/unrolltab_header_expand.png) repeat-x; }

/* corners for unrolled form tab expanded */
.unrollformtabulexpand		{ position: absolute; background: #24385B url(/images/forms/border/unrolltab_square_corner_expand.png) 0 0 no-repeat; }
.unrollformtabulfirstexpand	{ position: absolute; background: #24385B url(/images/forms/border/unrolltab_rounded_corner_expand.png) 0 0 no-repeat; }
.unrollformtaburexpand		{ position: absolute; right: 0px; background: #24385B url(/images/forms/border/unrolltab_square_corner_expand.png) -8px 0px no-repeat; }
.unrollformtaburfirstexpand	{ position: absolute; right: 0px; background: #24385B url(/images/forms/border/unrolltab_rounded_corner_expand.png) -8px 0px no-repeat; }
.unrollformtabllexpand		{ position: absolute; top: -3px; background: #24385B url(/images/forms/border/unrolltab_square_corner_expand.png) 0px -8px no-repeat; }
.unrollformtablllastexpand	{ position: absolute; top: -3px; background: #24385B url(/images/forms/border/unrolltab_rounded_corner_expand.png) 0px -8px no-repeat; }
.unrollformtablrexpand		{ position: absolute; right: 0px; top: -3px; background: #24385B url(/images/forms/border/unrolltab_square_corner_expand.png) -8px -8px no-repeat; }
.unrollformtablrlastexpand	{ position: absolute; right: 0px; top: -3px; background: #24385B url(/images/forms/border/unrolltab_rounded_corner_expand.png) -8px -8px no-repeat; }

/* unrolled form tab collapsed */
.unrollformtabheadercollapse	{ padding: 5px; border-bottom: 1px solid #cccccc; background: #24385B url(/images/forms/border/unrolltab_header_collapse.png) repeat-x; }

/* unrolled form tab collapsed */
.unrollformtablcollapse		{ width: 4px; font-size: 0px; background: #24385B url(/images/forms/tab/unrolltab_bg.png); }
.unrollformtabrcollapse		{ width: 4px; font-size: 0px; background: #24385B url(/images/forms/tab/unrolltab_bg.png); }
.unrollformtabtcollapse		{ height: 4px; font-size: 0px; background: #24385B url(/images/forms/tab/unrolltab_bg.png); }
.unrollformtabbcollapse		{ height: 3px; font-size: 0px; background: #24385B url(/images/forms/tab/unrolltab_bg.png); }
...
.unrollformtaburfirstcollapse		{ position: absolute; right: 0px; background: #24385B url(/images/forms/border/unrolltab_rounded_corner_collapse.png) -8px 0px no-repeat; }
.unrollformtabllcollapse		{ position: absolute; }
.unrollformtablllastcollapse		{ position: absolute; top: -5px; background: #24385B url(/images/forms/border/unrolltab_rounded_corner_collapse.png) 0px -8px no-repeat; }
.unrollformtablrcollapse		{ position: absolute; right: 0px; }
.unrollformtablrlastcollapse		{ position: absolute; top: -5px; right: 0px; background: #24385B url(/images/forms/border/unrolltab_rounded_corner_collapse.png) -8px -8px no-repeat; }

/*form subtab bar */
.bgsubtabbar			{ background-color: #DEE1E7; }
.subtabblock			{ background-color: #DEE1E7; }
.bdsubtabblock			{ border-style: solid; border-color: #DEE1E7; }
.subtabcontent			{ background-color: #FFFFFF; }
.nlsubtabcontent		{ background-color: #FFFFFF; }

.formsubtab			{ color: #666666; padding: 5px; background: #24385B url(/images/forms/tab/subtab_off.png) repeat-x; }

.formsubtabon			{ padding: 2px 5px 2px 5px; background: #24385B url(/images/forms/tab/subtab_on.png) repeat-x; }
.formsubtaboff			{ padding: 2px 5px 2px 5px; border-bottom: 1px solid #808080; background: #607799 url(/images/forms/tab/subtab_off.png) repeat-x; }
...
.formsubtabcorner		{ background-color: #DEE1E7; }

/* unrolled form subtab expanded */
.unrollformsubtabheaderesep		{ height: 3px; font-size: 0px; background: #24385B url(/images/forms/border/unrollsubtab_header_sep.png) repeat-x; }
.unrollformsubtablexpand		{ width: 3px; font-size: 0px; background: #24385B url(/images/forms/border/unrollsubtab_l_expand.png) repeat-y; }
.unrollformsubtabrexpand		{ width: 3px; font-size: 0px; background: #24385B url(/images/forms/border/unrollsubtab_r_expand.png) repeat-y; }
.unrollformsubtabtexpand		{ height: 4px; font-size: 0px; background: #24385B url(/images/forms/border/unrollsubtab_t_expand.png) repeat-x; }
.unrollformsubtabbexpand		{ height: 4px; font-size: 0px; background: #24385B url(/images/forms/border/unrollsubtab_b_expand.png) repeat-x; }
.unrollformsubtabheaderexpand:not(.uir-page-search__highlight--secondary)		{ padding: 5px; background: #24385B url(/images/forms/border/unrollsubtab_header_expand.png) repeat-x; }

/* corners for unrolled form subtab expanded */
.unrollformsubtabulexpand		{ position: absolute; background: #24385B url(/images/forms/border/unrollsubtab_square_corner_expand.png) 0 0 no-repeat; }
.unrollformsubtabulfirstexpand		{ position: absolute; background: #24385B url(/images/forms/border/unrollsubtab_rounded_corner_expand.png) 0 0 no-repeat; }
.unrollformsubtaburexpand		{ position: absolute; right: 0px; background: #24385B url(/images/forms/border/unrollsubtab_square_corner_expand.png) -7px 0px no-repeat; }
.unrollformsubtaburfirstexpand		{ position: absolute; right: 0px; background: #24385B url(/images/forms/border/unrollsubtab_rounded_corner_expand.png) -7px 0px no-repeat; }
...
/* unrolled form subtab collapsed */
.unrollformsubtabheadercollapse		{ padding: 5px; border-bottom: 1px solid #cccccc; background: #24385B url(/images/forms/border/unrollsubtab_header_collapse.png) repeat-x; }

/* corners for unrolled form subtab collapsed */
.unrollformsubtabulcollapse		{ position: absolute; }
.unrollformsubtabulfirstcollapse	{ position: absolute; background: #24385B url(/images/forms/border/unrollsubtab_rounded_corner_collapse.png) 0 0 no-repeat; }
.unrollformsubtaburcollapse		{ position: absolute; right: 0px; }
.unrollformsubtaburfirstcollapse	{ position: absolute; right: 0px; background: #24385B url(/images/forms/border/unrollsubtab_rounded_corner_collapse.png) -7px 0px no-repeat; }
.unrollformsubtabllcollapse		{ position: absolute; top: -5px; }
.unrollformsubtablllastcollapse		{ position: absolute; top: -5px; background: #24385B url(/images/forms/border/unrollsubtab_rounded_corner_collapse.png) 0px -7px no-repeat; }
.unrollformsubtablrcollapse		{ position: absolute; top: -5px; right: 0px; }
.unrollformsubtablrlastcollapse		{ position: absolute; top: -5px; right: 0px; background: #24385B url(/images/forms/border/unrollsubtab_rounded_corner_collapse.png) -7px -7px no-repeat; }

.bgontabsub		{ background-color: #24385B; border-top: 1px solid #808083; border-bottom: 1px solid #808083; }
...
.bgontabsubmid		{ background-color: #24385B; border-top: 1px solid #808083; border-bottom: 1px solid #808083; }
...
.bgon			{ background-color: #24385B; }
.bgoff			{ background-color: #607799; }
.headbar		{ font-size: 8pt; color: #B4BBC7; text-decoration: none; background-color: #24385B; }
.headbarsub		{ color: #B4BBC7; }
.headbarsubnolink	{ color: #B4BBC7; }
.crosslinktitle		{ color: #B4BBC7; }
.crosslinktext,
.crosslinktextul,
a.newbar		{ color: #E4EAF4; }
.crumb			{ color: #6F84A5; text-decoration: none; }
.crumbover		{ color: #6F84A5; }
.ontab			{ color: #FFFFFF; }
.offtab			{ color: #000000; }
...
.listtextnoneditleft	{ border-width: 2px 0 0 2px; border-color: #24385B; }
.listtextnonedit	{ border-width: 2px 0 0 0; border-color: #24385B; }
.listtextnoneditright	{ border-width: 2px 2px 0 0; border-color: #24385B; }
...
.machineButtonRow	{ background-color: #24385B; font-size: 8pt; padding: 2px 2px 2px 2px; vertical-align: top; }

/*non-inline edit machine */
.listfocusedrowleft		{ border-width: 2px 0 2px 2px; border-color: #24385B; }
.listfocusedrow			{ border-width: 2px 0 2px 0; border-color: #24385B; }
.listfocusedrowright		{ border-width: 2px 2px 2px 0; border-color: #24385B; }
.listfocusedrowleftright	{ border-width: 2px 2px 2px 2px; border-color: #24385B; }
...
.listinlinefocusedrowleft	{ border-width: 2px 0 2px 2px; border-color: #24385B; }
.listinlinefocusedrow		{ border-width: 2px 0 2px 0; border-color: #24385B; }
.listinlinefocusedrowright	{ border-width: 2px 2px 2px 0; border-color: #24385B; }
.listinlinefocusedrowleftright	{ border-width: 2px 2px 2px 2px; border-color: #24385B; }
...
.batchxxgridlisttextbot		{ background-color: #E0E6EF; font-size: 8pt ; padding: 2px 5px 2px 5px; color: #000000; border-style: solid dotted dotted dotted; border-width: 1px 1px 1px 1px; border-color: #E0E6EF black black black; vertical-align: top; }
.batchxxgridlisttextmid		{ background-color: #E0E6EF; font-size: 8pt ; padding: 2px 5px 2px 5px; color: #000000; border-style: solid dotted solid dotted; border-width: 1px 1px 1px 1px; border-color: #E0E6EF black #E0E6EF black; vertical-align: top; }
.batchxxgridlisttexttop		{ background-color: #E0E6EF; font-size: 8pt ; padding: 2px 5px 2px 5px; color: #000000; border-style: dotted dotted solid dotted; border-width: 1px 1px 1px 1px; border-color: black black #E0E6EF black; vertical-align: top; }
.batchxxgridlisttextuni		{ background-color: #E0E6EF; font-size: 8pt ; padding: 2px 5px 2px 5px; color: #000000; border-style: dotted; border-width: 1px 1px 1px 1px; border-color: black black black black; vertical-align: top; }
...
.seltexttable			{ background-color: #E0E6EF; font-size: 8pt; padding: 2px 5px 2px 5px; border-style: solid; border-width: 1px 0 0 0; border-color: white; vertical-align: top; }
.seltexttablectr		{ background-color: #E0E6EF; font-size: 8pt ; text-align: center; padding: 2px 5px 2px 5px; border-style: solid; border-width: 1px 0 0 0; border-color: white; vertical-align: top; }
.seltexttablert			{ background-color: #E0E6EF; font-size: 8pt ; text-align: right; padding: 2px 5px 2px 5px; border-style: solid; border-width: 1px 0 0 0; border-color: white; vertical-align: top; }

.sellisttext,
.sellisttexthl			{ font-size: 8pt; color: #000000; padding: 2px 5px 2px 5px ; background-color: #E0E6EF; border-style: solid; border-width: 1px 1px 1px 1px; border-color: white #E0E6EF #E0E6EF #E0E6EF; vertical-align: top; }
.sellisttextctr,
.sellisttexthlctr		{ font-size: 8pt; color: #000000; text-align: center; padding: 2px 5px 2px 5px; background-color: #E0E6EF; border-style: solid; border-width: 1px 1px 1px 1px; border-color: white #E0E6EF #E0E6EF #E0E6EF; vertical-align: top; }
.sellisttextrt,
.sellisttexthlrt		{ font-size: 8pt; color: #000000; text-align: right; padding: 2px 5px 2px 5px; background-color: #E0E6EF; border-style: solid; border-width: 1px 1px 1px 1px; border-color: white #E0E6EF #E0E6EF #E0E6EF; vertical-align: top; }
...
.ddmTextOver			{ background-color: #446AAB; color: #FFFFFF; FONT-SIZE: 8pt; text-decoration: none; vertical-align: middle; font-weight: normal; }
.ddmAnchor: hover		{ color: #FFFFFF; }
.ddmDiv				{ position: absolute; background: #E0E6EF; border-style: solid; border-width: 1px; border-color: #44546B; padding: 0; cursor: default; }
...
.quickadddiv			{ border-style: solid; border-color: #24385B; border-width: 1px 0 0 0; background-color: #EEEEEE; }
.quickadddivportlet		{ border-style: solid; border-color: white #EEEEEE #EEEEEE white; border-width: 1px; background-color: #EEEEEE; }
.quickaddportletheader		{ border-style: solid; border-color: #607998 #999999 #999999 #607998; border-width: 1px; background-color: #607998; }
...
.regmdtext		{ background-color: #E0E6EF; font-size: 8pt; color: #000000 ; padding: 2px; border-style: solid; border-width: 1px 0px 0px 0px; border-color: #8491A4 #000000 #000000 #000000; }
...
.rptcolheaderdiv	{ visibility: hidden; overflow: hidden; position: relative; background-color: #E0E6EF; color: #262626;}
...
.rptfooter			{ width: auto; position: absolute; bottom: 0; border-width: 0px; padding-top: 0px; margin: 0 0 0 0; background-color: #FFFFFF; overflow-x: auto; }
.rptfooterfilter		{ background-color: #E0E6EF; width: 100%; border-top: 1px solid #808080; }
...
.rptfindbox		{ text-align: right; vertical-align: bottom; background: #E0E6EF;}
.rptfindboxrow		{ background-color: #E0E6EF; vertical-align: middle; }
.rptfindboxrowimage		{ background-color: #E0E6EF; vertical-align: middle; }
...
.rptpreviewtext,
.rptpreviewtextrt	{ color: #666666; white-space: nowrap; padding: 2px 8px; }
...
.rptrowhighlight {background-color: #E0E6EF;}

/* this only applies to Mozilla. I had to apply the IE opacity using javascript to avoid the "Active content" dialog warning */
.rptpreviewopacity	{ position: absolute; border-style: solid; border-color: #999999; border-width: 3px 1px 3px 1px; background-color: rgba(85, 253, 0, 0.2); }

.navtitle		{ background-color: #24385B; font-weight: bold; font-family: Open Sans,Helvetica,sans-serif; font-size: 11px; padding: 3px ; border-style: solid; border-width: 1px 0px 1px 1px; border-color: #ffffff #9c9a97 #9c9a97 #ffffff; }
.navend			{ background-color: #24385B; font-weight: bold; font-family: Open Sans,Helvetica,sans-serif; padding: 3px ; border-style: solid; border-style: solid; border-width: 1px 0px 1px 0px; border-color: #ffffff #9c9a97 #9c9a97 #ffffff; }
...
.checkoutprogresstext	{ font-family: Open Sans,Helvetica,sans-serif; font-size: 8pt ; font-weight: normal; color: #24385B; border-style: none; }
...
.extcartborder		{ padding: 2px 5px; border-top: 1px solid #E0E6EF; font-size: 8pt; }
.extcartbordershaded	{ padding: 2px 5px; border-top: 1px solid #E0E6EF; font-size: 8pt ; background-color: #FFFFFF; }
.extcarttotal		{ padding: 2px 5px; border-top: 1px solid #E0E6EF; font-size: 10pt; }
.extcarttotalshaded	{ padding: 2px 5px; border-top: 1px solid #E0E6EF; font-size: 10pt ; background-color: #FFFFFF; }
...
.pgBntY .bntBgB,
.pgBntG .bntBgT,
.pgBntG .bntBgB			{ cursor: pointer; }



/* Theme color CSS variables */
:root {
	--nsn-uif-refreshed-color-primary-lightest: var(--uif-refreshed-color-primary-lightest, #EFF1F5);
	--nsn-uif-refreshed-color-primary-lighter: var(--uif-refreshed-color-primary-lighter, #DFE3EA);
	--nsn-uif-refreshed-color-primary-light: var(--uif-refreshed-color-primary-light, #BFC8D6);
	--nsn-uif-refreshed-color-primary-default: var(--uif-refreshed-color-primary-default, #607799);
	--nsn-uif-refreshed-color-primary-dark: var(--uif-refreshed-color-primary-dark, #4D5F7B);
	--nsn-uif-refreshed-color-primary-darker: var(--uif-refreshed-color-primary-darker, #3A485C);
	--nsn-uif-refreshed-color-primary-darkest: var(--uif-refreshed-color-primary-darkest, #27303E);
	--nsn-uif-refreshed-color-primary-default-70: rgba(96,119,153,0.70);
	--nsn-uif-refreshed-color-primary-default-95: rgba(96,119,153,0.95);
	--nsn-uif-refreshed-color-theme-secondary-light: #E0E6EF;
	--nsn-uif-refreshed-color-theme-secondary-dark: #24385B;
	--nsn-uif-refreshed-color-theme-secondary-dark-50: rgba(36,56,91,0.50);
}
...
.bgtabbar, .bgon, .tabur,
div.unrollformtabheaderexpand:not(.uir-page-search__highlight--primary), div.unrollformtabheadercollapse, div.unrollformtabheaderesep {
    background: none repeat scroll 0 0 #607799 !important;
}

div.unrollformtabheaderexpand.uir-page-search__highlight--primary {
	background-color: #607799;
}

div.bgsubtabbar, div.unrollformsubtabheadercollapse {
    color: #607799 !important;
}

div.bgsubtabbar, div.unrollformsubtabheaderexpand:not(.uir-page-search__highlight--secondary), div.unrollformsubtabheadercollapse {
    background: none repeat scroll 0 0 #E0E6EF !important;
}

div.unrollformsubtabheaderexpand.uir-page-search__highlight--secondary {
...
#popup_outerdiv div.uir-filter-area {
...
.x-window-tl, .x-window-header-default {
...
/* Lists */
.uir-list-top-button-bar,
.uir-list-control-bar[data-above="true"] {
...
.uir-page-search__highlight--default {
	animation: page-search-highlight-default normal 4s 1 ease-in-out;
}

.uir-page-search__tab {
	padding: 3px 8px 3px 8px;
}

.uir-page-search__column-header {
	background-color: #E5E5E5;
	padding: 0 !important;
	vertical-align: bottom;
}

.uir-page-search__highlight--primary {
	animation: page-search-highlight-primary normal 4s 1 ease-in-out;
}

.uir-page-search__highlight--secondary {
	animation: page-search-highlight-secondary normal 4s 1 ease-in-out;
}

.uir-page-search__highlight-outline.uir-page-search__highlight--default,
.uir-page-search__highlight-outline.uir-page-search__highlight--primary,
.uir-page-search__highlight-outline.uir-page-search__highlight--secondary {
	animation: page-search-highlight-outline normal 4s 1 ease-in-out;
}

@keyframes page-search-highlight-default {
	0% {
		background-color: rgba(147, 166, 99, 0);
	}
	10% {
		background-color: rgba(147, 166, 99, 1);
	}
	20% {
		background-color: rgba(147, 166, 99, 0);
	}
...
@keyframes page-search-highlight-primary {
	0% {
		background-color: #607799;
	}
	10% {
...
@keyframes page-search-highlight-secondary {
	0% {
		background-color: #E0E6EF;
	}
	10% {
...
@keyframes page-search-highlight-outline {
	0% {
		outline: rgba(147, 166, 99, 0) 2px solid;
		outline-offset: 2px;
	}
	10% {
		outline: rgba(147, 166, 99, 1) 2px solid;
		outline-offset: 2px;
	}
	20% {
		outline: rgba(147, 166, 99, 0) 2px solid;
